        ...
        _this.geocoder.geocode({
            ...
            if (status == google.maps.GeocoderStatus.OK) {
                if (results[0]) {
                    ...
                    $('#latitude').val(_this.marker.getPosition().lat());
                    $('#longitude').val(_this.marker.getPosition().lng());
...
AutocompleteMapGeocoder.prototype.getLongitude = function () {
    return this.longitude.val();
}

AutocompleteMapGeocoder.prototype.getLatitude = function () {
